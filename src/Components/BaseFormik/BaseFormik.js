		...
		<>
			...
			<form onSubmit={_formik.handleSubmit} noValidate>
				<div className="mb-3">
					...
					<input
						type="email"
						className={`form-control ${_formik.touched.email && _formik.errors.email && "is-invalid"} `}
						id="inputEmail"
						name="email"
				...
				<div className="mb-3">
					...
					<input
						type="password"
						className={`form-control ${_formik.touched.password && _formik.errors.password && "is-invalid"
							}`}
						id="inputPassword"
						name="password"
				...
				<div className="mb-3 form-check">
					<input
						...
						name="isMajor"
						id="exampleCheck1"
						checked={_formik.values.isMajor}
						onChange={_formik.handleChange}
					/>
			...
			<section className="mt-4">
				...
				{_formik.submitCount > 0 && (
					<pre>
						{JSON.stringify(_formik.values, null, 2)}{" "}
						{JSON.stringify(_formik.errors, null, 2)}
					</pre>
				)}
			</section>
		</>
